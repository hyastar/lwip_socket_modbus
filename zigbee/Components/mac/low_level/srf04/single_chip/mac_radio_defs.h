...
/* RFC_OBS_CTRL0 (partially undocumented) */
#define RFC_OBS_CTRL_PA_PD_INV        0x68

/* OBSSEL1 (undocumented) */
#define OBSSEL1                       XREG( 0x6244 )
#define OBSSEL1_OBS_CTRL0             0xFB

/* RFC_OBS_CTRL1 (partially undocumented) */
#define RFC_OBS_CTRL_LNAMIX_PD_INV    0x6A

/* OBSSEL4 (undocumented) */
#define OBSSEL4                       XREG( 0x6247 )
#define OBSSEL4_OBS_CTRL4             0xFC
...
#define MAC_RADIO_TX_POWER_MAX_DBM              19
#elif defined (HAL_PA_LNA_CC2590)
#define MAC_RADIO_TX_POWER_MAX_DBM              11
#else
#define MAC_RADIO_TX_POWER_MAX_DBM              22
#endif
...
#define MAC_RADIO_RSSI_LNA_OFFSET(x)            st(  x += HAL_PA_LNA_RX_GAIN() ? MAC_RADIO_RSSI_LNA_HGM_OFFSET : MAC_RADIO_RSSI_LNA_LGM_OFFSET; )
#endif
...
#define HAL_PA_LNA_RX_GAIN()                          ( P0_7 )
#endif
...
extern void macRadioTurnOnPower(void);
extern void macRadioTurnOffPower(void);
