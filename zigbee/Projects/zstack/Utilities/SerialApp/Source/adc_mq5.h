/**************************************************************************************************
  ...
  Description:    MQ5 可燃气体传感器模块驱动 头文件。
                  (V3.2 版: 支持非阻塞 OSAL 事件, 使用 P0.6)
                  (依赖: hal_adc.h, OSAL.h)
***************************************************************************************************/
...
/**
 * @brief   (V3.2 新增) 读取 MQ5 传感器的 ADC 原始值。
 *
 ...
 * @return  写入缓冲的数据长度 (字节)。
 *
 * @note    根据 V3.1 规范 (DeviceType 0x21):
