...
/* 基础配置选项 */
#define configUSE_PREEMPTION                            1                       /* 1: 抢占式调度器, 0: 合作式调度器, 无默认需定义 */
...
#define configMINIMAL_STACK_SIZE                        128                     /* 定义空闲任务的栈空间大小, 单位: Byte, 无默认需定义 */
...
#define configUSE_RECURSIVE_MUTEXES                     1                       /* 1: 使能递归互斥信号量, 默认: 0 LWIP*/
...
#define configUSE_QUEUE_SETS                            1                       /* 1: 使能消息队列, 默认: 0 */
#define configUSE_TIME_SLICING                          1                       /* 1: 使能时间片调度, 默认: 1 */
#define configUSE_NEWLIB_REENTRANT                      0                       /* 1: 任务创建时分配Newlib的重入结构体, 默认: 0 */
#define configENABLE_BACKWARD_COMPATIBILITY             1                       /* 1: 使能兼容老版本, 默认: 1 LWIP*/
#define configNUM_THREAD_LOCAL_STORAGE_POINTERS         0                       /* 定义线程局部指针变量的个数, 默认: 0 */
#define configSTACK_DEPTH_TYPE                          uint16_t                /* 定义任务堆栈深度的数据类型, 默认: uint16_t */
#define configMESSAGE_BUFFER_LENGTH_TYPE                size_t                  /* 定义消息缓冲区中每条消息的长度, 默认: size_t */
...
#define configUSE_TICK_HOOK                             0                       /* 1: 使能SysTick中断钩子函数, 无默认需定义 */
...
/* 协程相关定义 */
#define configUSE_CO_ROUTINES                           0                       /* 1: 使能合作式调度相关函数, 默认: 0 */
#define configMAX_CO_ROUTINE_PRIORITIES                 2                       /* 定义用户可使用的最大合作式任务优先级, 最大优先级=configMAX_CO_ROUTINE_PRIORITIES-1, 无默认configUSE_CO_ROUTINES为1时需定义 */
